...
%type <node> program stmt_list stmt expr InputStmt OutputStmt AsgStmt IfStmt WhileStmt RepeatStmt DoWhileStmt BREAK_ CONTINUE_ ID_ NUM_
...
RepeatStmt: REPEAT_ stmt_list UNTIL_ '(' expr ')' { $$ = makeNode(REPEATUNTIL, VOID, $2, NULL, $5, "REPEAT");}
